...
为了获得更好的响应式开发体验和更轻量级的状态管理，本项目已将前端框架从 React 迁移至 Vue 3。

*   **框架**: Vue 3 (Composition API) + Vite (Bun 运行 Vite 速度极快)
*   **可视化**: Vue Flow (基于 React Flow 的 Vue 实现，性能卓越)
*   **状态管理**: Pinia (Vue 官方推荐，比 Zustand 更贴合 Vue 响应式原理)
*   **UI 系统**: 基于 Tailwind CSS 的自定义组件（代码即样式，AI 容易理解和修改）
